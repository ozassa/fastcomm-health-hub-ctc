...
export const trackLeadFormStart = (utmData: UTMData) => {
  // Google Analytics
  if (typeof window !== 'undefined' && window.gtag) {
...
export const trackLeadFormSubmit = (leadData: LeadData) => {
...
export const trackLeadFormError = (errorData: ErrorData) => {
  // Google Analytics
  if (typeof window !== 'undefined' && window.gtag) {
...
export const trackFieldInteraction = (fieldData: FieldData) => {
...
export const trackPageEngagement = (engagementData: EngagementData) => {
  if (typeof window !== 'undefined' && window.gtag) {
...
export const trackLinkedInConversion = (leadData: LeadData) => {
