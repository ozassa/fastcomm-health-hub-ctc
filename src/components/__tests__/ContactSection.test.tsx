...
describe('ContactSection', () => {
  it('renders contact form with all required fields', () => {
    ...
    expect(screen.getAllByText(/cargo/i)[0]).toBeInTheDocument(); // Use getAllByText and select first match
  ...
  it('validates phone format', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/telefone deve ter 10 ou 11 dígitos/i)).toBeInTheDocument();
    });
  });
